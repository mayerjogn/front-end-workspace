...
// #content2에 #contetn1의 내용을 대입

$('#content2').html($('#content1').html());

// #contetn1의 a태그 속성 href에 https://naver.com 대입 속성 수정에는 attr prop input의 밸류값 수정은 var
...
$('#content4').text($('#content3').text()); // 태그빼고 텍스트만 알려줌
$('#content4').text('<strong>Hello~</strong>'); // 태그 인식못하고 다 텍스트로 나옴
...
// 버튼 클릭 시 요소 복제
$('#btn1').click(function(){
   const item = $('#item1').clone(true); // true 안넣으면 이벤트는 복제 안됨 false가 기본값
